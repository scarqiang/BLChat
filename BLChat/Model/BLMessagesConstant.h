...
//
#pragma mark - collection node cell
extern NSString * const kBLMessagesCollectionNodeCellDefaultAvatarName;
extern CGFloat const kBLMessagesCollectionNodeCellAvatarHeight;
extern CGFloat const kBLMessagesCollectionNodeCellSenderNameMaxWidth;

#pragma mark - bubble
extern NSString * const kBLMessagesIncomingBubbleImageName;
extern NSString * const kBLMessagesIncomingBubbleHighlightedImageName;
extern NSString * const kBLMessagesOutgoingBubbleImageName;
extern NSString * const kBLMessagesOutgoingBubbleHighlightedImageName;
extern NSString * const kBLMessagesPlainIncomingBubbleImageName;
